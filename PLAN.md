...
- [ ] reset과 interactive rebase의 안전한 Undo/Redo 지원
...
| 항목 | 상태 | 비고 |
| --- | --- | --- |
| P0.1 Operation recovery와 Undo/Redo | 진행 중 | commit/checkout/branch 삭제/clean rebase Undo/Redo, reflog ref 복구, recovery schema allowlist 검증 |
